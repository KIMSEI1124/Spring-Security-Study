...
//      검증 로직
        ...
        if (item.getQuantity() == null || item.getQuantity() >= 9999) {
            bindingResult.rejectValue("quantity", "max", new Object[]{"10,000"}, null);
        }
...
//      검증 로직
    ...
    /**
     * V5와의 차이점 "@Validated"를 추가함으로써 코드를 줄일 수 있다.
     */
    @PostMapping("/add")
