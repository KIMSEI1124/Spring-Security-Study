...
//        queryFactory = new JPAQueryFactory(em);
        ...
        // when
        Member findMember = queryFactory    // 권장하는 방법
                .select(member)
                .from(member)
        ...
        // then
        Assertions.assertEquals(Objects.requireNonNull(findMember).getUsername(), "member1");
    }
    ...
    public void theta_join() {
        ...
        List<Member> result = queryFactory
                .select(member)
                .from(member, team) // 세타 조인은 "from"에 나열한다.
...
//                .on(team.name.eq("teamA"))
    ...
    public void join_on_no_relation() {
        ...
        List<Tuple> result = queryFactory
                .select(member, team)
                .from(member) // 세타 조인은 "from"에 나열한다.
    ...
    public void subQuery() {
        // 별칭이 중복되면 안되는 경우에는 새로 생성해서 사용한다.
    ...
    public void concat() {
        //{username}_{age}
        List<String> result = queryFactory
                // 숫자는 문자형이 아니기 때문에 stringValue 로 문자형으로 변환해주었다.
    ...
    public void findDtoByJPQL() {
        List<MemberDto> result = em.createQuery("select new com.study.querydsl.dto.MemberDto(m.username, m.age) from " +
    ...
    @Test
    public void findDtoByUserDtoField() {
        QMember memberSub = new QMember("memberSub");
    ...
    public void dynamicQuery_BooleanBuilder() {
        ...
        Assertions.assertEquals(Objects.requireNonNull(result).size(), 1);
    }
